...
def main() -> int:
    ap = argparse.ArgumentParser(description="Verify Practical Companion MANIFEST size and SHA256 entries.")
    ...
    args = ap.parse_args()
    return verify(pathlib.Path(args.companion_root).resolve(), strict=args.strict, label="Companion MANIFEST")
